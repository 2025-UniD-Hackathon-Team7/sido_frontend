import svgPaths from "./svg-weua7ugp54";
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[18.549px] items-start left-[11.99px] top-[9.37px] w-[102.902px]" data-name="Text">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#5fa895] text-[14px]">상호작용형 미션</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="absolute h-[35.991px] left-[23.99px] top-[119.98px] w-[364.315px]" data-name="Heading 1">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[36px] left-0 text-[30px] text-neutral-900 text-nowrap top-[-3.53px] whitespace-pre">퇴근길 자리 양보</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[52.011px] left-[23.99px] top-[167.96px] w-[364.315px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[26px] left-0 text-[16px] text-neutral-600 top-[-2.31px] w-[359px]">대중교통에서 필요한 사람에게 자리를 양보해보세요</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="content-stretch flex h-[15.993px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px relative shrink-0 text-[#bb4d00] text-[12px] text-center">💡 100 SEED = 나무 1그루로 변환</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[24.003px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-900 text-nowrap top-[-2.16px] whitespace-pre">미션 가이드</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="content-stretch flex h-[19.998px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-neutral-900">상황 찾기</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[22.752px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[14px] text-neutral-600 text-nowrap top-[-1.31px] whitespace-pre">자연스러운 타이밍을 찾아보세요</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="content-stretch flex h-[19.998px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-neutral-900">미션 실천</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[22.752px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[14px] text-neutral-600 text-nowrap top-[-1.31px] whitespace-pre">진심을 담아 행동으로 옮기기</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="content-stretch flex h-[19.998px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-neutral-900">완료 확인</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="h-[22.752px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[14px] text-neutral-600 text-nowrap top-[-1.31px] whitespace-pre">미션 완료 버튼을 눌러주세요</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="content-stretch flex h-[19.998px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-neutral-900">도움말</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[45.503px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[22.75px] left-0 text-[14px] text-neutral-700 top-[-1.31px] w-[266px]">상대방이 거절해도 괜찮아요. 용기를 낸 당신이 이미 멋져요!</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="content-stretch flex h-[19.998px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-neutral-600">난이도</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="absolute content-stretch flex h-[19.998px] items-start left-[275.25px] top-0 w-[27.995px]" data-name="Text">
      <p className="basis-0 font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-neutral-600">쉬움</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24.003px] relative shrink-0 w-[101.598px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24.003px] relative w-[101.598px]">
        <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24px] left-[17.81px] text-[14px] text-nowrap text-white top-0 whitespace-pre">포기할래요</p>
      </div>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="h-[24.003px] relative shrink-0 w-[101.598px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24.003px] relative w-[101.598px]">
        <p className="absolute font-['Arimo:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-nowrap text-white top-[-2.16px] whitespace-pre">미션 완료하기</p>
      </div>
    </div>
  );
}
